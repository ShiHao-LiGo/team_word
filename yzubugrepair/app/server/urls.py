...
from .views import ProjectView, DatasetView, DataUpload, LabelView, StatsView, GuidelineView, UsersView, RelationshipView
...
#############   #   ###########3
    path('projects/<int:project_id>/relationships/',
         RelationshipView.as_view(), name='relationship-management'),
###############################33
