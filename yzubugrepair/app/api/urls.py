...
from .views import Me, Features, Users, Health, RelationshipAnnotationList, RelationshipAnnotationDetail
from .views import ProjectList, ProjectDetail
from .views import LabelList, RelationshipList, LabelDetail, RelationshipDetail, ApproveRelationshipsAPI, ApproveLabelsAPI, LabelUploadAPI, RelationshipUploadAPI
...
urlpatterns = [
    ...
    ######  ########################3
    path('projects/<int:project_id>/relationships',
         RelationshipList.as_view(), name='relationship_list'),
    path('projects/<int:project_id>/relationship-upload',
         RelationshipUploadAPI.as_view(), name='relationship_upload'),
    path('projects/<int:project_id>/relationships/<int:relationship_id>',
         RelationshipDetail.as_view(), name='relationship_detail'),
    ######   ##############33
    ...
    ###########
    path('projects/<int:project_id>/docs/<int:doc_id>/approve-relationships',
         ApproveRelationshipsAPI.as_view(), name='approve_relationships'),
    path('projects/<int:project_id>/docs/<int:doc_id>/relationships-annotations',
         RelationshipAnnotationList.as_view(), name='relationships-annotation_list'),
    path('projects/<int:project_id>/docs/<int:doc_id>/relationshipAnnotations/<int:relationshipAnnotation_id>',
         RelationshipAnnotationDetail.as_view(), name='relationshipAnnotation_detail'),
    ############
